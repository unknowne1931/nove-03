...
const Kanva4 = () => {
  ...
  useEffect(() => {
    ...
    fetch(`http://localhost:5000/kan/add/04/data/04/${qno}?key=${reactkey}`)
    .then(resp => resp.json())
  ...
  const Submitt1 = (e) => {
    e.preventDefault();
    axios.post("http://localhost:5000/kan/add/04/vall1/04",{value1, qno})
    .then(res => {
  ...
  const Submitt2 = (e) => {
    e.preventDefault();
    axios.post("http://localhost:5000/kan/add/04/vall2/04",{value2, qno})
    .then(res => {
      if(res.data.Status === "200") {
        True()
      }
  ...
  const Submitt3 = async (e) => {
    e.preventDefault();
    axios.post("http://localhost:5000/kan/add/04/vall3/04",{value3, qno})
    .then(res => {
      if(res.data.Status === "200") {
        True()
      }
    ...
    const Submitt4 = (e) => {
      e.preventDefault();
      axios.post("http://localhost:5000/kan/add/04/vall4/04",{value4, qno})
      .then(res => {
        if(res.data.Status === "200") {
          True()
        }else{
