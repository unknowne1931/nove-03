...
const Kanva3 = () => {
  ...
  useEffect(() => {
    ...
    fetch(`http://localhost:5000/kan/add/03/data/03/${qno}?key=${reactkey}`)
    .then(resp => resp.json())
  ...
  const Submitt1 = (e) => {
    e.preventDefault();
    axios.post("http://localhost:5000/kan/add/03/vall1/03",{value1, qno})
    .then(res => {
  ...
  const Submitt2 = (e) => {
    e.preventDefault();
    axios.post("http://localhost:5000/kan/add/03/vall2/03",{value2, qno})
    .then(res => {
      if(res.data.Status === "200") {
        True()
      }
  ...
  const Submitt3 = async (e) => {
    e.preventDefault();
    axios.post("http://localhost:5000/kan/add/03/vall3/03",{value3, qno})
    .then(res => {
      if(res.data.Status === "200") {
        True()
      }
    ...
    const Submitt4 = (e) => {
      e.preventDefault();
      axios.post("http://localhost:5000/kan/add/03/vall4/03",{value4, qno})
      .then(res => {
        if(res.data.Status === "200") {
          True()
        }else{
